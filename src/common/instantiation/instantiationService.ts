...
import { Graph } from 'lib/common/instantiation/graph';
import { SyncDescriptor } from 'lib/common/instantiation/descriptors';
import { ServiceIdentifier, IInstantiationService, ServicesAccessor, _util, optional } from 'lib/common/instantiation/instantiation';
import { ServiceCollection } from 'lib/common/instantiation/serviceCollection';
import { IdleValue } from 'lib/common/async';
		...
		try {
			const accessor: ServicesAccessor = {
				get: <T>(id: ServiceIdentifier<T>, isOptional?: typeof optional) => {
					...
					if (_done) {
						throw new Error('[illegalState] service accessor is only valid during the invocation of its target method');
					}
